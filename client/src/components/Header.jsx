...
const Header = () => {
  ...
  return (
   ...
   <p className='my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs text-gray-500'>
    A modern blogging platform made for builders, developers, and tech enthusiasts.
Write clean tutorials, share your coding journey, and integrate markdown, code snippets, and more.
Fast, flexible, and fully yours start building your blog today.
   </p>
