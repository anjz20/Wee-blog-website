...
const NewsLetter = () => {
  return (
    <div className='flex flex-col items-center justify-center text-center space-y-2 my-32'>
        <h1 className='md:text-4xl text-2xl font-semibold'>Never miss a blog like our expert guides, tutorials, and thought pieces.</h1>
        <p className='md:text-lg text-gray-500/70 pb-8'>One click away from your next favorite read Subscribe to stay in the loop with our latest blogs.</p>
